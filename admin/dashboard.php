<div class="wrap tocc-admin-dashboard">
    <h1>LCCI Member Registrations</h1>
    ...
    $members = TOCC_Registration_Handler::get_all_members($per_page, $offset);
            ...
            <?php if (!empty($members)) : ?>
                <?php foreach ($members as $member) : ?>
                    <tr>
                        ...
                        <td>
                            <span class="payment-status status-<?php echo esc_attr($member->payment_status); ?>">
                                <?php echo esc_html(ucfirst($member->payment_status)); ?>
                            </span>
                        </td>
        ...
        <div class="tablenav bottom">
            <div class="tablenav-pages">
                ...
                <span class="pagination-links">
                    <?php if ($page > 1) : ?>
                        <a class="prev-page" href="?page=tocc_registrations&paged=1">&laquo;</a>
                        <a class="prev-page" href="?page=tocc_registrations&paged=<?php echo $page - 1; ?>">‹</a>
                    <?php endif; ?>
                    
                    <?php echo esc_html(sprintf('Page %d of %d', $page, $total_pages)); ?>
                    
                    <?php if ($page < $total_pages) : ?>
                        <a class="next-page" href="?page=tocc_registrations&paged=<?php echo $page + 1; ?>">›</a>
                        <a class="next-page" href="?page=tocc_registrations&paged=<?php echo $total_pages; ?>">&raquo;</a>
                    <?php endif; ?>
                </span>
            </div>
        </div>

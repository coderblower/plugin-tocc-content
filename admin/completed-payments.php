<div class="wrap tocc-admin-dashboard">
    ...
    $query = "
        SELECT m.*, u.user_email, u.user_login, p.status as payment_status, p.payment_method, p.amount, p.transaction_id, p.created_at as payment_date
            ...
            <?php if (!empty($members)) : ?>
                <?php foreach ($members as $member) : ?>
                    <tr>
                        ...
                        <td>
                            <code><?php echo esc_html($member->transaction_id ?: 'N/A'); ?></code>
                        </td>
        ...
        <div class="tablenav bottom">
            <div class="tablenav-pages">
                ...
                <span class="pagination-links">
                    <?php if ($page > 1) : ?>
                        <a class="prev-page" href="?page=tocc_completed_payments&paged=1">&laquo;</a>
                        <a class="prev-page" href="?page=tocc_completed_payments&paged=<?php echo $page - 1; ?>">‹</a>
                    <?php endif; ?>
                    
                    <?php echo esc_html(sprintf('Page %d of %d', $page, $total_pages)); ?>
                    
                    <?php if ($page < $total_pages) : ?>
                        <a class="next-page" href="?page=tocc_completed_payments&paged=<?php echo $page + 1; ?>">›</a>
                        <a class="next-page" href="?page=tocc_completed_payments&paged=<?php echo $total_pages; ?>">&raquo;</a>
                    <?php endif; ?>
                </span>
            </div>
        </div>
